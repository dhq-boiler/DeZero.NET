...
{
    public class GreaterThanOrEqual : Function
    {
        ...
        public override Variable[] Forward(Params args)
        {
            ...
            using var y = xp.greater_equal(_x0.Data.Value, _x1.Data.Value);
            return [y.copy().Relay(this)];
        }

        public override Variable[] Backward(Params args)
        {
            // GreaterThanOrEqual は勾配を持たない操作なので、
            // 入力と同じ形状のゼロ行列を返します。
