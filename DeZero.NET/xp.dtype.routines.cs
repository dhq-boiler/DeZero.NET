...
namespace DeZero.NET
{
    public static partial class xp
    {
        ...
        ///     to an integer.<br></br>
        ///     Notes
        ///     Starting in Cupy 1.9, can_cast function now returns False in ‘safe’
        ...
        public static bool can_cast(Dtype from_, Dtype to, string casting = "safe")
        {
            ...
            {
                return np.can_cast(from_.NumpyDtype, to.NumpyDtype, casting);
            }
        }
        ...
        ///     Notes
        ///     Starting in Cupy 1.9, promote_types function now returns a valid string
        ...
        public static Dtype promote_types(Dtype type1, Dtype type2)
        {
            ...
            {
                return new Dtype(np.promote_types(type1.NumpyDtype, type2.NumpyDtype));
            }
        }
        ...
        public static Dtype min_scalar_type(this NDarray a)
        {
            ...
            {
                return new Dtype(np.min_scalar_type(a.NumpyNDarray));
            }
        }

        /*
        /// <summary>
        ///	Returns the type that results from applying the Cupy
        ///	type promotion rules to the arguments.<br></br>
        ///	
        ///	Type promotion in Cupy works similarly to the rules in languages
        ...
        ///	  If the 3 is a
        ///	32-bit integer, the Cupy rules indicate it can’t convert losslessly
        ...
        */
        ...
        public static Dtype common_type(this NDarray array2, NDarray array1)
        {
            ...
            {
                return new Dtype(np.common_type(array2.NumpyNDarray, array1.NumpyNDarray));
            }
        }

        /// <summary>
        ///     Return the scalar dtype or Cupy equivalent of Python type of an object.
        /// </summary>
        /// <param name="rep">
        ...
        public static Dtype obj2sctype(object rep, object @default = null)
        {
            ...
            {
                return new Dtype(np.obj2sctype(rep, @default));
            }
        }

        /// <summary>
        ///     Create a data type object.<br></br>
        ///     A Cupy array is homogeneous, and contains elements described by a
        ///     dtype object.<br></br>
            ...
            string byteorder = null)
        {
            ...
            {
                np.format_parser(formats, names, titles, aligned, byteorder);
            }
        }
        ...
        ///     Notes
        ///     For developers of Cupy: do not instantiate this at the module level.<br></br>
            ...
            Delegate float_to_str = null, string title = null)
        {
            ...
            {
                np.MachAr(float_conv, int_conv, float_to_float, float_to_str, title);
            }
        }
        ...
        public static bool issubdtype(Dtype arg2, Dtype arg1)
        {
            ...
            {
                return np.issubdtype(arg2.NumpyDtype, arg1.NumpyDtype);
            }
        }
        ...
        public static bool issubsctype(Dtype arg2, Dtype arg1)
        {
            ...
            {
                return np.issubsctype(arg2.NumpyDtype, arg1.NumpyDtype);
            }
        }
